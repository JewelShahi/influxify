  ...
  return (
    <div className="flex justify-center z-50">
      ...
      <div className="flex px-4 py-2 absolute bg-white items-center mx-auto justify-between w-[90%] rounded-standard top-10 basis-[250px]">
        ...
        <div className="hidden lmd:flex flex-row items-center space-x-10">
      ...
      <div
        className={
          clicked
            ? "flex flex-col h-screen lmd:hidden m-auto items-center justify-center bg-primary w-full "
            : "hidden"
        }
      >
