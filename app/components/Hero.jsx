    ...
    <div className="min-h-screen w-full bg-heroBg/80">
      <div className="flex flex-col items-center justify-center md:w-full">
        <div className="px-3 py-2 items-center text-center">
          ...
          <div className="items-center justify-center inline-flex flex-col md:flex-row">
            <button className="text-white transition ease-in-out delay-[50ms] bg-black hover:bg-primary-hover duration-[150ms] h-14 p-2 -mt-4 rounded-standard mb-4 md:mb-0">
              Get Started
            </button>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              fill="none"
            >
              {/* Placeholder content for SVG Path */}
        ...
        <div className="flex flex-col w-auto px-4 py-2 items-center">
          <div>
            <Image
              src="/assets/heroMain.png"
              alt="s"
